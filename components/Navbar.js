...
export default function Navbar() {
  ...
  return (
  <nav className="relative bg-black text-white px-6 py-2 shadow-md z-50">

      {/* Desktop layout: 3-column grid to keep center links perfectly centered */}
      <div className="w-full max-w-7xl mx-auto md:grid md:grid-cols-3 md:items-center">
        {/* Left: Website Name */}
      ...
      {/* Mobile Menu Button (Hamburger) - positioned on the right */}
      <button
        className="md:hidden text-white text-2xl z-50 absolute right-6 top-3"
